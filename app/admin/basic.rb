ActiveAdmin.register Basic do
  ...
  form do |f|
    ...
    f.inputs do
      ...
      f.input :eg_boolean, :as => :select, :hint => 'This is notmally a checkbox by default, can only be true or false', :label => 'Boolean', :boolean_style => :inline
      ...
      f.input :eg_decimal,  :label => 'Decimal', :hint => 'Store a number with commas eg 10.22232'
